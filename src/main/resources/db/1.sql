...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`xunwu` /*!40100 DEFAULT CHARACTER SET latin1 */;
...
CREATE TABLE `house` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=30 DEFAULT CHARSET=utf8mb4 COMMENT='房屋信息表';
...
(15,'富力城 国贸CBD 时尚休闲 商务办公',6200,70,2,10,20,3,2005,1,'2017-09-06 18:56:14','2018-06-29 14:25:20','bj','hdq','Fhxz_c16YmEmIz5UVxrp6ihwbvCk',2,10,1,'融泽嘉园',2,0,'龙域西二路'),
(16,'富力城 国贸CBD 时尚休闲 商务办公',6300,70,2,10,20,0,2012,1,'2017-09-06 19:53:35','2018-06-28 09:11:38','bj','hdq','FvkO1FFyGbrxCP_1O9tA94u2qvbP',1,-1,1,'融泽嘉园',2,0,'龙域西二路'),
(17,'二环东直门地铁站附近、王府井、天安门、国贸、三里屯、南锣鼓巷',3000,35,1,5,10,2,2013,1,'2017-09-06 20:45:35','2018-06-28 09:11:36','bj','hdq','FpVYJRsLykrBRyUSCEOeqsqWU-bt',1,200,0,'融泽嘉园',2,0,'龙域西二路'),
(18,'华贸城 东向一居挑空loft 干净温馨 随时可以签约',5700,52,1,7,20,0,2012,1,'2017-09-06 21:01:02','2018-06-28 09:11:34','bj','hdq','Fl1lNikhmMIecbTn-JTsurxugtFU',2,1085,1,'融泽嘉园',2,0,'龙域西二路'),
(19,'望春园板楼三居室 自住精装 南北通透 采光好视野棒！',9200,132,3,6,14,0,2005,1,'2017-09-06 22:44:25','2018-06-28 09:11:25','bj','hdq','Fp1xPKVYtPsCeVHVQVW0Hif2FXk7',2,1108,2,'融泽嘉园',2,0,'龙域西二路'),
(20,'高大上的整租两居室 业主诚意出租',5400,56,2,12,20,0,2012,3,'2017-09-06 23:39:50','2018-06-08 10:50:57','bj','hdq','FvVqU8LneZZ5xaLBAOM1KXR2Pz1X',2,-1,1,'融泽嘉园',2,0,'龙域西二路'),
(21,'新康园 正规三居室 精装修 家电家具齐全',1900,18,1,13,25,0,2012,1,'2017-09-07 00:52:47','2018-06-28 09:11:23','bj','hdq','FnuOFbFtDYTbpPdFoZthR-R0tszC',3,1302,0,'融泽嘉园',2,0,'龙域西二路'),
(24,'湖光壹号望京华府183-387㎡阔景大宅',50000,288,5,1,1,0,2015,1,'2017-09-07 11:42:20','2018-06-27 18:03:06','bj','hdq','FlgoAylUv1ilx1SAtxSyBCJF3bwb',5,200,3,'融泽嘉园',2,0,'龙域西二路'),
(25,'测试房源-编辑',3000,59,2,10,20,0,2010,3,'2017-10-28 22:34:48','2017-11-11 12:22:50','bj','cpq','FtbxR2LY98lnnX_TPOgOPzti3k7G',2,1000,1,'融泽嘉园',2,0,'龙域中街'),
(29,'测试',11111,111,1,11,111,0,2016,1,'2018-06-28 02:31:23','2018-06-29 16:06:25','bj','dcq','FhRdUkZQvlByVYno45zVT6DbDS60',2,-1,0,'融泽嘉园',2,0,'龙域西二路');
...
(33,'阿道夫','撒打发','爱的色放','阿道夫',0,'啊打发手动阀撒旦',1,'13号线',1,'西直门',26),
(34,'阿道夫','撒打发','爱的色放','阿道夫',0,'啊打发手动阀撒旦',1,'13号线',1,'西直门',27),
(35,'','','','',0,'adf s',1,'13号线',11,'北苑',28),
(36,'','','','',0,'龙域西二路融泽嘉园',1,'13号线',16,'东直门',29);
...
CREATE TABLE `house_picture` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=88 DEFAULT CHARSET=utf8mb4 COMMENT='房屋图片信息';

/*Data for the table `house_picture` */

insert  into `house_picture`(`id`,`house_id`,`cdn_prefix`,`width`,`height`,`location`,`path`) values 
(68,19,'http://7xo6gy.com1.z0.glb.clouddn.com/',911,683,NULL,'Fp1xPKVYtPsCeVHVQVW0Hif2FXk7'),
...
(87,29,'http://pb0pz1b7c.bkt.clouddn.com/',520,347,NULL,'FhRdUkZQvlByVYno45zVT6DbDS60');
...
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8mb4 COMMENT='预约看房信息表';
...
(11,15,1,NULL,3,'2018-06-28 23:29:27','2018-06-28 23:30:31','2018-06-29 11:00:00','13571728016',2),
(12,16,1,NULL,2,'2018-06-28 23:29:33','2018-06-28 23:30:29','2018-06-29 11:00:00','13571728016',2),
(13,18,1,NULL,2,'2018-06-28 23:29:57','2018-06-28 23:30:26','2018-06-29 11:00:00','13571728016',2);
...
CREATE TABLE `role` (
  ...
  KEY `user_id` (`user_id`)
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8mb4 COMMENT='用户角色表';
...
CREATE TABLE `user` (
  ...
  `status` int(2) unsigned DEFAULT '0' COMMENT '用户状态 0-正常 1-封禁',
...
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8mb4 COMMENT='用户基本信息表';
...
(1,'test','wali@wali.com','15111111111','b498cf17471f366519d07849203202d5',1,'2017-08-25 15:18:20','2017-08-25 12:00:00','2018-06-29 12:29:07','http://7xo6gy.com1.z0.glb.clouddn.com/99ff568bd61c744bf31185aeddf13580.png'),
(2,'admin','admin@imooc.com','1388888888','55b3d0936a3fb63168d57a6bda0ddbbf',1,'2017-08-27 09:07:05','2017-08-27 09:07:07','2017-10-21 15:03:57','http://7xo6gy.com1.z0.glb.clouddn.com/99ff568bd61c744bf31185aeddf13580.png'),
(10,'大帅哥',NULL,'15829671110','1ed047a30e6abefb2f65adaa21a8c9c0',NULL,'2018-06-28 04:08:34','2018-06-28 04:08:34','2018-07-06 18:37:02',NULL);
